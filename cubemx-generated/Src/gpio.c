...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DS18B20PIN_GPIO_Port, DS18B20PIN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DS18B20PIN_Pin */
  GPIO_InitStruct.Pin = DS18B20PIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DS18B20PIN_GPIO_Port, &GPIO_InitStruct);
